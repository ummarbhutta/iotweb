...
namespace IotWeb.Common.Http
{
    public class BaseHttpServer : IServer
    {
        ...
        private IMultiPartFileStorageHandler _multiPartFileStorageHandler;
        public IMultiPartFileStorageHandler MultiPartFileStorageHandler
        {
            get { return _multiPartFileStorageHandler; }
        }

        protected BaseHttpServer(ISocketServer server, IMultiPartFileStorageHandler multiPartFileStorageHandler)
            : this(server)
        {
            _multiPartFileStorageHandler = multiPartFileStorageHandler;
        }
